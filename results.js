...
const questions = {
  ...
  3: {
    ...
    options: {
      a: 'Transparência e explicabilidade da IA',
      b: 'Redução e mitigação de vieses da IA',
      c: 'Regulamentação e governança da IA',
      d: 'Avaliação de riscos da IA',
      e: 'Avaliação de confiabilidade da IA',
    },
  },
  4: {
